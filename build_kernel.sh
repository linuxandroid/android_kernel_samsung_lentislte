...
make -C . O=out/ apq8084_sec_defconfig VARIANT_DEFCONFIG=apq8084_sec_lentislte_ktt_defconfig SELINUX_DEFCONFIG=selinux_defconfig  TIMA_DEFCONFIG=tima_defconfig 
fi
make -C . O=out/  -j4
